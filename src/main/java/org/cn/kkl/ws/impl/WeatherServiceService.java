 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceService", targetNamespace = "http://impl.ws.kkl.cn.org/", wsdlLocation = "http://localhost:9090/cxf/ws/weatherService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICESERVICE_QNAME = new QName("http://impl.ws.kkl.cn.org/", "WeatherServiceService");
    ...
    public IWeatherService getWeatherServicePort() {
        return super.getPort(new QName("http://impl.ws.kkl.cn.org/", "WeatherServicePort"), IWeatherService.class);
    }
    ...
    public IWeatherService getWeatherServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.ws.kkl.cn.org/", "WeatherServicePort"), IWeatherService.class, features);
    }
